...
# domain random
CDN="https://raw.githubusercontent.com/wehoi/helloyou/main/ssh"
cd /root
...
echo -e "[ ${BGreen}INFO${NC} ] กำลังจพติดตั้งระบบ"
apt install git curl -y >/dev/null 2>&1
apt install python -y >/dev/null 2>&1
echo -e "[ ${BGreen}INFO${NC} ] พร้อมติดตั้ง"
sleep 0.5
echo -ne "[ ${BGreen}INFO${NC} ] ตรวจสอบอนุญาต : "

echo -e "$BGreen ได้รับอนุญาต!$NC"
sleep 2
...
echo ""
clear
    echo -e "$BBlue                     คั้งค่าโดเมน     $NC"
    echo -e "$BYellow----------------------------------------------------------$NC"
    echo -e "$BGreen 1. ใช้โดเมนของสคริป $NC"
    echo -e "$BGreen 2. ใช้โดเมนของตัวเอง $NC"
    echo -e "$BYellow----------------------------------------------------------$NC"
    read -rp " กรุณาเลือก : " dns
	...
	echo -e "${BGreen}สำเร็จ!${NC}"
    sleep 2
    clear
    
#install ssh ovpn
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen      ระบบกำลังติดตั้ง SSH           $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/wehoi/helloyou/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          ระบบกำลังติดตั้ง  XRAY              $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/wehoi/helloyou/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/wehoi/helloyou/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/wehoi/helloyou/main/menu/versi  )
...
echo ""
echo "===========================ติดต่อ============================" | tee -a log-install.txt
echo "------------------------------java--------------------------------" | tee -a log-install.txt
...
echo -e "
"
echo -ne "[ ${yell}WARNING${NC} ] ต้องการรีบูตเครื่องหรือไม่ ? (y/n)? "
read answer
